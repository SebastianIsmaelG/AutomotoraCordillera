  ...
  try {
    ...
    if (!$cnn) {
      die("Conexion Fallida: " . mysqli_connect_error());
        ...
        $sql = "SELECT c.codigo_cotizacion, marcas.marca, v.modelo, c.nombre_cliente, c.telefono_cliente, c.email_cliente, c.mensaje_cliente, c.estado, c.fecha from cotizaciones as c INNER JOIN vehiculos as v ON v.codigo_vehiculo=c.vehiculo_visto INNER JOIN marcas on marcas.codigo_marca = v.marca WHERE (c.estado='pendiente') ";
        ...
        while ($fila = mysqli_fetch_row($rs)){
          ...
          echo "<td>".$fila["5"]."</td>";
          echo "<td>".$fila["6"]."</td>";
          echo "<td> <form method='post' action='../paginas_funciones/comprobar_cotizacion.php'><input type='hidden' name='id_cotizacion' value='".$fila["0"]."'><input type='submit' class='btn btn-primary' name='btn_comprobar' value='Realizadas'></form></td>";
                         ...
                         <div class='container'>
                          <form action='../paginas_funciones/eliminar_cotizacion.php' method='post'>
                            <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12'>
                              ...
                              <p class='upper'>Estado cotizacion <span style='color:red;'>" . $fila["7"] . "</span></p>
                            </div>
                      </div>
